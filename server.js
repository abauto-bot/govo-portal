  ...
  try {
    ...
    res.send(page('GOVO Customer App', `
      ...
      <section class="card"><h2>Quick Actions</h2><div class="quick-grid">
        <a class="btn" href="/shops">Shops</a><a class="btn" href="/services">Request Service</a><a class="btn secondary" href="/services?q=emergency">Emergency Service</a><a class="btn secondary" href="/track">Track</a><a class="btn secondary" href="/order">Order</a><a class="btn secondary" href="/support">Support</a><a class="btn secondary" href="/merchant">Join Merchant</a><a class="btn secondary" href="/provider">Join Provider</a><a class="btn secondary" href="/category/food">Food</a>
      </div></section>
...
async function handleServiceRequestSubmit(req, res, providerId = '') {
  ...
  const p = provider.rows[0] || {};
  if (data.provider_id && !p.id) return res.status(404).send(page('Provider Not Found', `<section class="card"><h1>Provider Not Found</h1><a class="btn" href="/services">Back Services</a></section>${pilotPartnerEmpty('provider')}`, 'services'));
  const missing = [];
...
app.get('/service/request/success', (req, res) => {
  const code = String(req.query.code || req.query.id || '');
  res.send(page('Service Request Submitted', `<section class="card app-hero"><span class="pill">Request Received</span><h1>Service Request Submitted</h1><p>GOVO team and provider will review your request.</p><h2>Request Code: ${esc(code)}</h2><div class="actions"><a class="btn" href="/track?code=${encodeURIComponent(code)}">Track Request</a><a class="btn secondary" href="/services">Back to Services</a></div></section>`, 'services'));
});
